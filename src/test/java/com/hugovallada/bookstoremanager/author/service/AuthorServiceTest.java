...
public class AuthorServiceTest {
    ...
    void whenValidAuthorIdIsGivenThenItShouldBeDeleted() {
        ...
        Mockito.doNothing()
                .when(authorRepository).deleteById(expectedDeletedAuthorId);

        Mockito.when(authorRepository.findById(expectedDeletedAuthorId))
    ...
    void whenInvalidAuthorIdIsGivenThenAnExceptionShouldBeThrown() {
        ...
        Mockito.when(authorRepository.findById(expectedInvalidAuthorId))
                .thenReturn(Optional.empty());
