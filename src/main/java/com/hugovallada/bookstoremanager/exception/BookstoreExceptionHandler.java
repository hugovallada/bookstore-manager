package com.hugovallada.bookstoremanager.exception;
...
@ControllerAdvice // Informa ao spring, q essa classe intercepta os controllers em caso de erro
public class BookstoreExceptionHandler extends ResponseEntityExceptionHandler {

    @ExceptionHandler(EntityNotFoundException.class) // especifica qual o erro q esse método irá tratar
    ...
    @ExceptionHandler(EntityExistsException.class) // especifica qual o erro q esse método irá tratar
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException exception, HttpHeaders headers, HttpStatus status, WebRequest request) {
        return buildResponseEntity(HttpStatus.BAD_REQUEST, "Malformed JSON body and/or field(s) error(s)", Collections.singletonList(exception.getLocalizedMessage()));
    }
